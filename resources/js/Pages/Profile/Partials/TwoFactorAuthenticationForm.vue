        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                <p>
                    ...
                    may retrieve this token from your phone's Google Authenticator application.
                </p>
            </div>
            ...
            <div class="mt-5">
                <div v-if="!twoFactorEnabled">
                    <ConfirmsPassword @confirmed="enableTwoFactorAuthentication">
                        <PrimaryButton :class="{ 'opacity-25': enabling }" type="button" :disabled="enabling"> Enable </PrimaryButton>
                    </ConfirmsPassword>
                </div>
